...
The development version supports stable GLC metadata schemas 1.0.0 and
2.0.0, experimental reading of the 3.0.0 development schema, immutable
registry revisions, selective downloads, and GitHub-hosted Git LFS
objects.
...
and filters participants, devices, datasets, file groups, and source
variables. It builds a small configurable preview before exporting an
